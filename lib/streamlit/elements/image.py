    ...
    def image(
        ...
        *,
        ...
        use_container_width : bool
            ...
            parent container. If ``use_container_width`` is ``True`` (default),
            Streamlit sets the width of the figure to match the width of the
            parent container. If ``use_container_width`` is ``False``, Streamlit
            sets the width of the image to its natural width, up to the width of
        ...
        if use_column_width is not None:
            ...
            if use_container_width is None and width is None:
                # If image is a list, default use_container_width to be False
                if isinstance(image, list):
                    use_container_width = False
                else:
                    # Default use_container_width to be True if not explicitly set,
                    # and width is None
